...
public class DetailActivity5 extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        btnBook = findViewById(R.id.btn_booking5);
        btnYeuThich = findViewById(R.id.btn_yeuthich5);
    ...
    private void setupListeners() {
        btBack.setOnClickListener(v -> {
            Intent intent = new Intent(DetailActivity5.this, MainActivity.class);
            startActivity(intent);
        });

        btnBook.setOnClickListener(v -> {
            Intent intent = new Intent(DetailActivity5.this, BookingActivity5.class);
            startActivity(intent);
        });
        btnYeuThich.setOnClickListener(v -> {
            String sanBongInfo = "Sân tennis Điện Lực - 5.250đ/giờ";
    ...
    private void addSampleComments() {
        comments.add(new Comment("Bùi Văn T", "Sân rộng, thiết bị hiện đại!", 5));
        comments.add(new Comment("Mai Thị U", "Phục vụ chu đáo, giá hợp lý", 4.5f));
        comments.add(new Comment("Phan Văn V", "Môi trường chuyên nghiệp", 4));
