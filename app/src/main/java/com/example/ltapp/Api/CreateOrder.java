package com.example.ltapp.Api;



import com.example.ltapp.Constant.AppInfo;
import com.example.ltapp.Helper.Helpers;
...
public class CreateOrder {
    private class CreateOrderData {
     ...
     public JSONObject createOrder(String amount) throws Exception {
        ...
        Log.d("ZaloPay", "Clean amount: " + cleanAmount);
        
        CreateOrderData input = new CreateOrderData(cleanAmount);
