...
public class DetailActivity2 extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        btnBook = findViewById(R.id.btn_booking2);
        btnYeuThich = findViewById(R.id.btn_yeuthich2);
    ...
    private void setupListeners() {
        ...
        btnYeuThich.setOnClickListener(v -> {
            String sanBongInfo = "Sân bóng Thực nghiệm - 475.000đ/giờ";
    ...
    private void addSampleComments() {
        comments.add(new Comment("Phạm Văn X", "Sân rộng rãi, thoáng mát!", 5));
        comments.add(new Comment("Nguyễn Thị Y", "Giá cả phải chăng, sân đẹp", 4.5f));
        comments.add(new Comment("Trần Văn Z", "Dịch vụ tốt, nhân viên thân thiện", 4));
